    ...
    return (
      <View style={styles.container}>
        <View style={{height: height, width: width, marginTop: height*0.3, borderRadius: 40, backgroundColor: '#FFF'}}>
            ...
            <Image source={require('./peaceful.jpg')} style={{borderRadius: 30, height: 200, width: 250, alignSelf: 'center'}}/>
            ...
            <Ionicons onPress={() => this.props.navigation.navigate("AngerScreen2")}
